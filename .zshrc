...
plugins=(git zsh-syntax-highlighting zsh-autosuggestions ansible z zoxide docker docker-compose zsh-completions kubectl tmux zsh-history-substring-search eza fzf tmux)
